...
class VerificaSolicitudDescarga():
    ...
    def __generar_soapreq__(self, rfc_solicitante, id_solicitud):
        ...
        verificasolicituddescarga = etree.SubElement(
            body, '{{{}}}{}'.format(self.NSMAP['des'], 'VerificaSolicitudDescarga'))

        solicitud = etree.SubElement(
            verificasolicituddescarga, '{{{}}}{}'.format(self.NSMAP['des'], 'solicitud'))
        ...
        to_digest = etree.tostring(
            verificasolicituddescarga, method='c14n', exclusive=1)
